<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-select v-model="temp.consumeType" :placeholder="$t('table.importance')" clearable style="width: 90px" class="filter-item">-->
...
<!--      </el-table-column>-->
      ...
      <el-table-column label="类型" width="110px" align="center">
        <template slot-scope="{row}">
          <span v-if="row.consumeType==1">支出</span>
          <span v-if="row.consumeType==2">收入</span>
          <span v-if="row.consumeType==3">转账</span>
        </template>
      </el-table-column>
...
<!--        </el-form-item>-->
        ...
        <el-form-item label="源账户" prop="sourceAccount">
          <el-input v-model="temp.sourceAccount" />
        </el-form-item>
        <el-form-item label="目标账户" prop="targetAccount">
          <el-input v-model="temp.targetAccount" />
        </el-form-item>
        ...
        <el-form-item label-width="120px" label="选择时间" class="postInfo-container-item">
          <el-date-picker v-model="temp.createTime" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="Select date and time" />
        </el-form-item>
...
<script>
import { fetchList, fetchPv, createArticle, updateArticle,addOneExpand,tranferAccount,addOneIncome } from '@/api/article'
