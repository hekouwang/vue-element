...
export const asyncRoutes = [
...

  {
    ...
    children: [
      ...
      {
        path: 'classifyManage',
        component: () => import('@/views/example/classifyManage'),
        name: 'ClassifyManage',
        meta: { title: '分类管理', icon: 'list' }
      },
      {
        path: 'accountManage',
        component: () => import('@/views/example/accountManage'),
        name: 'AccountManage',
        meta: { title: '账户管理', icon: 'list' }
      },
      {
        path: 'wishManage',
        component: () => import('@/views/example/wishManage'),
        name: 'WishManage',
        meta: { title: '心愿管理', icon: 'list'  }
      }
    ]
  },
